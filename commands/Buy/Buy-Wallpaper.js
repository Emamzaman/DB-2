...
module.exports.run = async (bot, message, args) => {
    ...
    if (args[0] == '#001') {
        ...
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.001#.** را از قبل خریده اید   **|** ❌     `);
        ...
        .setColor("#f2ecec")
        .setDescription(`برای خرید والپیپر **.001#.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.002.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`برای خرید والپیپر **.#002.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.003.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`برای خرید والپیپر **.#003.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.004.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`برای خرید والپیپر **.#004.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.005.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`برای خرید والپیپر **.#005.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.006.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.#006.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.007.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.#007.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.008.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.#008.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.009.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.#009.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.010.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.#010.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.Barcelona.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.Barcelona.** نیاز به **.8000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 2000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.Real madrid.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.Real madrid.** نیاز به **.8000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 2000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.Juve.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.Juve.** نیاز به **.8000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 2000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.Esteghlal.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.Esteghlal.** نیاز به **.8000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 2000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.Perspolis.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.Perspolis.** نیاز به **.8000.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 2000) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما والپیپر **.011.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید والپیپر **.#011.** نیاز به **.1000.** پیکوین دارید ! **|** ❌    `);
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما والپیپر **.${args[0]}.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید والپیپر **.${args[0]}.** نیاز به **.2000.** پیکوین دارید ! **|** ❌    `);
