...
module.exports.run = async (bot, message, args) => {
    ...
    if (args[0] == '3') {
        ...
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.3.** را از قبل خریده اید   **|** ❌     `);
        ...
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول3.** را ندارید   **|** ❌     `);
    ...
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.3.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.2.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.2.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.1.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.1.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.Barcelona.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول4.** را ندارید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.Barcelona.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000)return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.Real madrid.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.Real madrid.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000)return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.Juve.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.Juve.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000)return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.Esteghlal.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.Esteghlal.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000)return message.channel.send(Embed)
        ...
        let Embed1 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما مدال **.Perspolis.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید مدال **.Perspolis.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000)return message.channel.send(Embed)
