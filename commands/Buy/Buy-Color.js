...
module.exports.run = async (bot, message, args) => {
 ...
 if (args[0] == 'red') {
        ...
        .setColor("#f2ecec")
        .setDescription(`شما رنگ **.قرمز.** را از قبل خریده اید   **|** ❌     `);
        ...
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **.2.** را ندارید بخاطر همین نمی تونید برای پروفایل خود **.رنگی.** را بخرید   **|** ❌     `);
...
.setDescription(`برای خرید رنگ **.قرمز.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 800) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما رنگ **.آبی.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed4 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **21.** را ندارید بخاطر همین نمی تونید برای پروفایل خود **.رنگی.** را بخرید   **|** ❌     `);
...
.setDescription(`برای خرید رنگ **.آبی.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 800) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما رنگ **.سبز.** را از قبل خریده اید   **|** ❌     `);
...
.setDescription(`برای خرید رنگ **.سبز.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 800) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما رنگ **.سیاه.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.سیاه.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 800) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما رنگ **.سفید.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.سفید.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.بنفش.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.بنفش.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
...
if (author < 800) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.زرد.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.زرد.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
...
if (author < 800) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.نارنجی.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.نارنجی.** نیاز به **.800.** پیکوین دارید ! **|** ❌    `);
...
if (author < 800) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.Barcelona.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.Barcelona.** نیاز به **.2000.** پیکوین دارید ! **|** ❌    `);
...
if (author < 2000) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.Real madrid.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.Real madrid.** نیاز به **.2000.** پیکوین دارید ! **|** ❌    `);
...
if (author < 2000) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.Juve.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.Juve.** نیاز به **.2000.** پیکوین دارید ! **|** ❌    `);
...
if (author < 2000) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.Esteghlal.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.Esteghlal.** نیاز به **.2000.** پیکوین دارید ! **|** ❌    `);
...
if (author < 2000) return message.channel.send(Embed)
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما رنگ **.Perspolis.** را از قبل خریده اید   **|** ❌     `);
    ...
    let Embed = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`برای خرید رنگ **.Perspolis.** نیاز به **.2000.** پیکوین دارید ! **|** ❌    `);
