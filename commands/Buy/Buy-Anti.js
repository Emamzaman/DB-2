...
module.exports.run = async (bot, message, args) => {
    ...
    if (args[0] == 'anti-rob') {
        let Embed5 = new Discord.MessageEmbed()
            .setColor("#f2ecec")
            .setDescription(`شما این آیتم را از قبل خریده بودید **|** ❌    `);
        ...
        let Embed2 = new Discord.MessageEmbed()
            .setColor("#f2ecec")
            .setDescription("برای خرید آیتم **آنتی راب ** نیاز به **9000** پی کوین دارید **|** ❌   ");
    ...
    let Embed2 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription("برای خرید آیتم **آنتی راب ** نیاز به **11000** پی کوین دارید **|** ❌   ");
