...
module.exports.run = async (bot, message, args) => {
  ...
  if (args[0] == 'johansen') {
    ...
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Johansen.** نیاز به **.3000.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Salah** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Salah.** نیاز به **.1000.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Alexander** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Alexander.** نیاز به **.5500.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Eric** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Eric.** نیاز به **.7000.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Richard** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Richard.** نیاز به **.8500.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Barbara** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Barbara.** نیاز به **.9000.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Susan** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Susan.** نیاز به **.10000.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **Atan** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.Atan.** نیاز به **.13000.** پی کوین دارید  **|** ❌  ");
    ...
    let Embed5 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما قبلا کارکتر **David** رو خریده اید  **|** ❌   `);
    ...
    let Embed2 = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription("برای خرید کارکتر **.David.** نیاز به **.16000.** پی کوین دارید  **|** ❌  ");
