...
module.exports.run = async (bot, message, args) => {
  ...
  let author = db.fetch(`pcoin_${message.guild.id}_${user.id}`)
    ...
    .setColor("#f2ecec")
    .setDescription(`شما قبلا اسلحه **.Scar.** را خریده بودید  **|** ❌    `);
    ...
    .setColor("#f2ecec")
    .setDescription(" برای خرید اسلحه **.Scar.** نیاز به **.550.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.AK-47.** را خریده بودید  **|** ❌    `);
  ...
  if (green2colore > 0) return message.channel.send(Embed5)
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription("برای خرید اسلحه **.AK-47.** نیاز به **.650.** پیکوین دارید  **|** ❌   ");
        ...
        message.channel.send(Embed3)
          ...
          let Embed5 = new Discord.MessageEmbed()
          .setColor("#f2ecec")
          .setDescription(`شما قبلا اسلحه **.AUG.** را خریده بودید  **|** ❌    `);
          ...
          if (green2colore > 0) return message.channel.send(Embed5)
                let Embed2 = new Discord.MessageEmbed()
                .setColor("#f2ecec")
                .setDescription("برای خرید اسلحه **.AUG.** نیاز به **.650.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.kar98.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.kar98.** نیاز به **.600.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.M16.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.M16.** نیاز به **.600.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.MP5.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.MP5.** نیاز به **.500.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.FAMAS.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.FAMAS.** نیاز به **.500.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.UMP.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.UMP.** نیاز به **.500.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.Desert Eagle.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.Desert Eagle.** نیاز به **.500.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.P90.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.P90.** نیاز به **.500.** پیکوین دارید  **|** ❌   ");
  ...
  let Embed5 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(`شما قبلا اسلحه **.colt1911.** را خریده بودید  **|** ❌    `);
  ...
  let Embed2 = new Discord.MessageEmbed()
  .setColor("#f2ecec")
  .setDescription(" برای خرید اسلحه **.colt1911.** نیاز به **.500.** پیکوین دارید  **|** ❌   ");
