...
module.exports.run = async (bot, message, args) => {
    ...
    if (args[0] == 'level1') {
        ...
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول1.** را از قبل خریده اید   **|** ❌     `);
    ...
    .setColor("#f2ecec")
    .setDescription(`برای خرید رنک وی آی پی لول **.1.** نیاز به**.2500.** پیکوین دارید ! **|** ❌    `);
    if (author < 2500) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول2.** را از قبل خریده اید   **|** ❌     `);
        ...
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **.1.** را ندارید بخاطر همین نمی تونید وی آی پی لول **.2.** را بخرید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید رنک وی آی پی لول **.2.** نیاز به**.3500.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 3500) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول3.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed4 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **.2.** را ندارید بخاطر همین نمی تونید وی آی پی لول **.3.** را بخرید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید رنک وی آی پی لول **.3.** نیاز به**.4500.** پیکوین دارید ! **|** ❌    `);
    if (author < 4500) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول4.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed4 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **.3.** را ندارید بخاطر همین نمی تونید وی آی پی لول **.4.** را بخرید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید رنک وی آی پی لول **.4.** نیاز به**.2500.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 2500) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول5.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed4 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **.4.** را ندارید بخاطر همین نمی تونید وی آی پی لول **.5.** را بخرید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(` برای خرید رنک وی آی پی لول **.5.** نیاز به**.3500.** پیکوین دارید ! **|** ❌    `);
    ...
    if (author < 3500) return message.channel.send(Embed)
        ...
        let Embed5 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آی پی **.لول6.** را از قبل خریده اید   **|** ❌     `);
        ...
        let Embed4 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setDescription(`شما وی آپی لول **.5.** را ندارید بخاطر همین نمی تونید وی آی پی لول **.6.** را بخرید   **|** ❌     `);
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید گرید وی آی پی لول **.6.** نیاز به**.9000.** پیکوین دارید ! **|** ❌    `);
