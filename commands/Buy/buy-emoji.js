...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("#f2ecec")
    .setDescription(`برای خرید ایموجی پک **.AmongUS.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید ایموجی پک **.Pubg.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000) return message.channel.send(Embed)
        ...
        let Embed3 = new Discord.MessageEmbed()
        .setColor("#f2ecec")
        .setTitle(`Pubg Imoji Pack The DiscordBox`)
        ...
        let Embed = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`برای خرید ایموجی پک **.Original Style.** نیاز به**.1000.** پیکوین دارید ! **|** ❌    `);
    if (author < 1000) return message.channel.send(Embed)
