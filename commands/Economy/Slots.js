...
module.exports.run = async (bot, message, args) => {
  ...
  if (weekly !== null && timeout - (Date.now() - weekly) > 0) {
    ...
    let timeEmbed = new Discord.MessageEmbed()
     .setColor("#f2ecec")
     .setDescription(`شما همین الان قمار کردید   **|** ❌     
     \n\n ${time.hours}h ${time.minutes}m ${time.seconds}s دیگر میتوانید قمار کنید`);
    message.channel.send(timeEmbed)
  } else {
    let moneymore = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(`شما ${args[0]} پیکوین در کیف پولی خود ندارید  **|** ❌    `)
    .addField(`اگر فکر میکنید که پیکوین خود را در پی بانک گذاشتید این دستور را بزنید`, `!!take ${args[0]}`);

    let moneyhelp = new Discord.MessageEmbed()
    .setColor("#f2ecec")
    .setDescription(` لطفا مبلغ را وارد کنید   **|** ❌    `);
    ...
    if (win) {
        ...
        .setThumbnail("https://cdn.discordapp.com/emojis/780138062578712646.png?v=1")
            ...
            .addField("شما خیلی خوش شانس هستید دوباره قمار کنید و پیکوین خود را باز دوبرابر کنید <:emoji:778595734765174825> ", `!!slots ${money}`)
            .setColor("#f2ecec")
        ...
        .setThumbnail("https://cdn.discordapp.com/emojis/778316309050032149.png?v=1")
            .setDescription(`\nمتاسفانه شما  **.${money}.** پیکوین را باختید ❌`)
            .addField("ولی شما میتونید با یک قمار دیگه باخت خودتون رو جبران کنید <:emoji:778595734765174825> ", `!!slots ${money*2}`)
            .setColor("#f2ecec")
