...
.setColor("#f2ecec")
.setDescription(`شما نمی توانید به خود پول دهید  **|** ❌    `);
...
if(member11 == member22) {
 message.channel.send(mention);
  ...
  .setColor("#f2ecec")
  .setDescription(`لطفا شخص مورد نظر خودتون رو منشن کنید   **|** ❌    `);
  ...
  .setColor("#f2ecec")
  .setDescription(`لطفا مغدار را هم وارد کنید  **|** ❌    `);
  ...
  .setColor("#f2ecec")
  .setDescription(`شما نمیتونید بدون پیکوین آن را انتقال دهید  **|** ❌    `);
  ...
  .setColor("#f2ecec")
  .setDescription(`شما **.${args[1]}.** پیکوین ندارید  **|** ❌    `);
