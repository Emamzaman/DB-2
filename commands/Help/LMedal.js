...
module.exports.run = async (bot, message, args) => {
    ...
    .setDescription("**بخش لیست خرید مدال DB ** <:help:778600706729967647>   ")
   .addField("برای خرید مدال این دستور را استفاده کنید <:buy:778138002139381770> ", "<:cmd:811330358389243906>  `!!buy-medal <mname>`")
   .addField("برای خرید مدال نیاز به وی آی پی لول 3 دارید <:vip3:778704130654732328> ", "<:cmd:811330358389243906>  `!!vip-store`")
