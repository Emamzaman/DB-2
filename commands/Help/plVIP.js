...
module.exports.run = async (bot, message, args) => {
    ...
    .setDescription("**بخش لیست خرید وی آی پی DB ** <:help:778600706729967647>   ")
   .addField("برای خرید وی آی پی این دستور را استفاده کنید <:vip:778700786141102120>  ", "<:cmd:811330358389243906>  `!!buy-vip <level1>`")
