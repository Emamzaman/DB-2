...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("دستور خرید والپیپر <:buy:778138002139381770>", "<:cmd:811330358389243906>  `!!buy-wallpaper <#001>`")
    .addField("دستور فروش والپیپر <:sell:778188790228320266> ", "<:cmd:811330358389243906>  `!!sell-wallpaper <#001>`")
