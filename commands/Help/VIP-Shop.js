...
module.exports.run = async (bot, message, args) => {
   ...
   .addField("برای خرید وی آی پی این دستور را استفاده کنید <:buy:778138002139381770>", "<:cmd:811330358389243906>  `!!buy-vip <level1>`")
   ...
   .addField("لیست وی آپی ها <:list:778695104696418356> ", "<:cmd:811330358389243906>  `!!lvip`")
    .setColor("#f2ecec")
