    ...
    let user = message.author;
     ...
     if(args[0] == '1') {
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.1.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.2.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.3.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.Esteghlal.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.Perspolis.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.Juve.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.Barcelona.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما مدال **.Real madrid.** را ندارید که بفروشید   **|** ❌     `);
