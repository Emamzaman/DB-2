    ...
    let user = message.author;
     ...
     if(args[0] == 'red') {
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.قرمز.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.آبی.** را ندارید که بفروشید   **|** ❌     `);
       ...
       let bluecolor = await db.fetch(`blue_${user.id}`)
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.سبز.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.سیاه.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.سفید.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.نارنجی.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.زرد.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.بنفش.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.Barcelona.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.Juve.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.Esteghlal.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.Perspolis.** را ندارید که بفروشید   **|** ❌     `);
        ...
        let Embed2 = new Discord.MessageEmbed()
         .setColor("#00dcff")
        .setDescription(`شما رنگ **.Real madrid.** را ندارید که بفروشید   **|** ❌     `);
